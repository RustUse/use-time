...
RustUse/use-time is intentionally small and focused. Contributions should keep the public API explicit, typed, and pragmatic.
...
- `use-time` is the RustUse time primitives crate, not a CLI and not a general automation layer.
